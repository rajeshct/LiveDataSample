...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*CustomLiveData.get(Activity2.class.getSimpleName())
    ...
    public void updateData(View view) {
        //CustomLiveData.get("").changeValue("Activity2");
        RxSingleObject.getRxSingleObject().getPublishSubject().onNext("hello1");
        RxSingleObject.getRxSingleObject().getPublishSubject().onComplete();
